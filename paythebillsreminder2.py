...
from Tkinter import Tk, Frame, LEFT, RIGHT, BOTTOM, TOP, Label, Button, Checkbutton, X, IntVar, RIDGE, PhotoImage, Image
...
class BillList(Tk):
    ...
    def __init__(self):
        ...
        # self.iconbitmap(default=Image("photo", file=icon_path))
        self.title(app_title)
        self.wm_title(app_title)
